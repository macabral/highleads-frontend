<template>
  <div>
    <b-container fluid>
      ...
      <p>Selecione o arquivo para importar no format TXT ou CSV. A primeira coluna deve ser o Nome do Contato e a seguna coluna o email (Ex: Fulano,fulano@email.com'). Um nome, email por linha.</p>
